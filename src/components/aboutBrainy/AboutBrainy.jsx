...
const AboutBrainy = () => {
  return (
    <>
      ...
      <div className="animate__animated animate__fadeInLeft mx-auto max-w-screen-xl items-center gap-8 px-4 py-8 sm:py-16 md:grid md:grid-cols-2 lg:px-6 xl:gap-16">
        <img
